...
- `.claude/agent-memory-local/plan.md` — the full plan; read before starting any phase.
- `.claude/agent-memory-local/design.md` — naming conventions, component specs, data flow rules.
