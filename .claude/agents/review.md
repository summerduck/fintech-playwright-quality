...
- `.claude/agent-memory-local/ts/plan.md` — the phase-specific acceptance criteria and the review checklist.
- `.claude/agent-memory-local/ts/design.md` — naming conventions, component specs, Playwright rules.
